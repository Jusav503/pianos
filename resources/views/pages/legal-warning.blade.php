<x-app-layout>
    <div class="container">
        <article class="text-gray-500">
            ...
            <br>
            <p>En el momento en que accedas a este sitio web, asumes la condición de usuario, por lo que el contenido de este Aviso Legal te afecta directamente. Por eso, es importante que lo leas para disipar cualquier duda que puedas tener y tener conocimiento de causa sobre las condiciones que estás aceptando.</p>
            <br>
        ...
        <article class="text-gray-500">
            <h2 class="titles text-2xl">Normas de acceso al sito web</h2>
            <span class="text-black">Como usuario de nuestra web, también tienes una serie de obligaciones:</span>
        ...
        <article class="text-gray-500">
            ...
            <br>
            <p>Como titular de este sitio web, esta web no garantiza que los contenidos sean precisos o libres de error o que el libre uso de los mismos por parte de los usuarios no infrinja los derechos de terceras partes. El buen o mal uso de esta página y de sus contenidos es responsabilidad del usuario.</p>
            <br>
        ...
        <article class="text-gray-500">
            <h2 class="titles text-2xl">Enlaces o links</h2>
            <p>Este sitio web incluye enlaces o links a sitios de terceros. Las páginas pertenecientes a estos terceros no han sido revisadas ni son objeto de controles por nuestra parte, por lo que esta web no podrá ser considerada responsable de los contenidos de estos sitios web, ni de las medidas que se adopten relativas a su privacidad o al tratamiento de sus datos de carácter personal u otros que pudieran derivarse.</p>
            <br>
        ...
        <article class="text-gray-500">
            <h2 class="titles text-2xl">Enlaces de afiliación de Amazon</h2>
            <p>Este sitio web, de acuerdo a su finalidad, utiliza enlaces de afiliado de Amazon. Esto quiere decir que encontrarás enlaces de productos de Amazon a los que podrás acceder directamente desde nuestro sitio web pero que, en su caso, la compra la realizarás en Amazon, bajo sus propias condiciones en ese momento.</p>
        </article>
        <article class="text-gray-500">
            <h2 class="titles text-2xl">Limitación de responsabilidad</h2>
            <p>En ejercicio de su derecho como titular de esta web, te informamos de que BIGSEO no se hace responsable en ningún caso de lo siguiente:</p>
            <br>
            <ul>
                ...
                <li>- La falta de licitud, calidad, fiabilidad, utilidad y disponibilidad de los servicios prestados por terceros y puestos a disposición de los usuarios en este sitio web.</li>
                <li>- De los daños que pudieran provenir del uso ilegal o indebido de este blog.</li>
            </ul>
        </article>
        <article class="text-gray-500">
            <h2 class="titles text-2xl">Política de privacidad y protección de datos</h2>
